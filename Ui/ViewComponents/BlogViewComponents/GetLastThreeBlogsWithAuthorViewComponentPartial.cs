...
{
    public class GetLastThreeBlogsWithAuthorViewComponentPartial : ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public GetLastThreeBlogsWithAuthorViewComponentPartial(IHttpClientFactory httpClientFactory)
        {
