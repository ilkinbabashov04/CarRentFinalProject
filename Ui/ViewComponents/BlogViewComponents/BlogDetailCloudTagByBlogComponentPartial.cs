...
{
    public class BlogDetailCloudTagByBlogComponentPartial : ViewComponent
    {
        private readonly IHttpClientFactory _httpClientFactory;

        public BlogDetailCloudTagByBlogComponentPartial(IHttpClientFactory httpClientFactory)
        {
